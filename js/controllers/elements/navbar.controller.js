...
const html = `
    <button id="burger-btn"
        class="fixed p-2 text-[rgb(var(--text-from))] dark:text-[rgb(var(--card-from))] bg-[rgb(var(--body-from))] dark:bg-[rgb(var(--button-from))] shadow-md top-4 left-4 rounded-xl md:hidden backdrop-blur drop-shadow z-53">
    ...
    <div id="sidebar-wrapper"
        ...
        <aside id="sidebar"
            class="flex flex-col w-full h-full gap-6 px-4 py-6 overflow-y-auto bg-[rgb(var(--body-from))]/70 backdrop-blur md:bg-transparent md:backdrop-blur-none scrollbar-width-none">
            <header class="flex items-center justify-between px-2">
                <div class="flex items-center justify-between flex-1 gap-2">
                    ...
                    <a href="/html/general/news.html" id="bell-btn"
            ...
            <nav class="flex-1">
                <ul class="space-y-2">
                    ...
                    <li>
                        <div
                            ...
                            <ul id="mod-sp-enrollments"
                                class="rounded-b-lg pl-9 py-6 space-y-1 hidden hover:bg-gradient-to-tr hover:from-[rgb(var(--body-from))] hover:to-[rgb(var(--body-to))] group-hover:bg-gradient-to-tr group-hover:from-[rgb(var(--body-from))] group-hover:to-[rgb(var(--body-to))]">
                                <li><a href="/html/student-portal/cycle-enrollments.html"
                                        class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripción
                                        Ciclos</a>
                                </li>
                                <li><a href="/html/student-portal/subject-enrollments.html"
                                        class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripción
                                        Materias</a>
                                </li>
                            </ul>
                    ...
                    <!-- PERFIL -->
                    <li>
                        <a href="/html/general/profile.html"
                            class="block transition-shadow duration-300 bg-transparent group rounded-xl hover:shadow-lg nav-btn"
                            data-hash="#profile">
                            <div class="flex items-center gap-5 px-5 py-4 transition-colors duration-300 inner rounded-xl group-hover:bg-gradient-to-r group-hover:from-[rgb(var(--button-from))] group-hover:to-[rgb(var(--button-to))]"
                                id="nav-profile">
                                <div class="flex items-center justify-center h-14 w-14 profile-avatar"
                                    id="profile-avatar">
                                </div>
                                <span
                    ...
                    <!-- PRUEBAS -->
                    <li>
                        <a href="/html/general/testing.html"
                            class="block transition-shadow duration-300 bg-transparent group rounded-xl hover:shadow-lg nav-btn">
                            <div
                                class="flex items-center gap-5 px-5 py-4 transition-colors duration-300 inner rounded-xl group-hover:bg-gradient-to-r group-hover:from-[rgb(var(--button-from))] group-hover:to-[rgb(var(--button-to))]">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="flex-shrink-0 w-5 h-5 text-[rgb(var(--button-from))] transition-colors duration-300 group-hover:text-white drop-shadow stroke-current fill-none">
                                    <path d="M12 20v-9" />
    ...
    <template id="logout-template">
        <div class="flex flex-col gap-10 p-10 mx-auto" id="logout-modal">
            <div class="text-left">
                <span
            ...
            <div class="flex justify-end gap-4">
                <div id="logout-confirm" class="group">
                    <button type="button" class="secondary-btn-component" id="logout-confirm">
...
function attachBurgerMenu() {
    ...
    if (!burgerBtn || !sidebar) {
        console.warn('[Navbar] burger menu elements not found');
        return;
    }
    ...
    burgerBtn.addEventListener('click', () => {
        ...
        if (isOpen) {
            ...
            burgerBtn.classList.remove('ring-2', 'ring-[rgb(var(--button-from))]');
        } else {
            sidebar.classList.remove('-translate-x-full');
            burgerBtn.classList.add('ring-2', 'ring-[rgb(var(--button-from))]');
        }
    });
    ...
    document.addEventListener('click', (e) => {
        ...
        if (!clickedInsideSidebar && !clickedBurger && !sidebar.classList.contains('-translate-x-full')) {
            sidebar.classList.add('-translate-x-full');
            burgerBtn.classList.remove('ring-2', 'ring-[rgb(var(--button-from))]');
        }
    });
